...
export const data: PortfolioData = {
  ...
  aboutme: {
    ...
    introduceMyself: `안녕하세요! 언제나 성장하고자 노력하는 개발자 강화수입니다. 새로운 것을 배우는 것을 꺼리지 않으며, 언제나 더 깊은 전문성을 갖추기 위해 부단히 노력합니다. 주로 TypeScript 기반의 웹 서비스를 만듭니다. 프론트엔드와 백엔드 영역을 가리지 않고 모두 즐겁게 개발하고 있습니다. 게임 개발 및 게임 관련 서비스에도 관심이 많습니다.
\n- 결과 예측이 가능하며 재사용성을 갖춘 코드를 구성하고자 노력합니다. 지속적으로 배포되고 발전할 수 있는 시스템을 구성하기를 좋아합니다. 
\n- 주로 서비스를 처음부터 구성하는 작업을 해왔습니다. 기술적 관점에서만 서비스를 바라보지 않고 조직적/사업적/운영적 측면을 함께 고려하는 것이 습관화 되어 있습니다. 
    ...
    skillSet: [
      {
        ...
        items: [
          ...
          'Remote-data-management: (react-query, swr)',
      ...
      },
      {
        ...
        items: [
          ...
          'IaC: AWS Cloud Development Kit(CDK), CloudFormation',
        ...
        projects: [
          {
            ...
            mypart:
              '저는 리드 개발자(풀스택)로 업무에 임하였습니다. DB설계, 인프라 구성, 백엔드, 프론트엔드, 자동화 배치작업 구성, CI/CD 구성 등의 업무를 담당했습니다. 이와 함께, 스크럼 마스터의 역할도 함께 수행하였습니다.',
